...
#'
#' @return 单一林下位点的加权进界邻体散射荫蔽度
#' @export
#'
#' @examples
#' a=data.frame(x=75,y=75,size=0)
#' b=Understory.light::b
#' Understory.light::Tan.dependence.Diffuse_S.single(a=a,b=b,tan=2.8,MI=10.660,wei=0.5)
#' Understory.light::Tan.dependence.Diffuse_S.single(a=a,b=b,tan=2.8,MI=10.660,wei=0.5,tan2=1)
