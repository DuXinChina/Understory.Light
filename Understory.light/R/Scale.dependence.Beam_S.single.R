...
#'
#' @return 单一林下位点的尺度化加权直射荫蔽度
#' @export
#'
#' @examples
#' a=data.frame(x=75,y=75,size=0)
#' b=Understory.light::b
#' Understory.light::Scale.dependence.Beam_S.single(a=a,b=b, aaix=6.2, baix=14, mi=1.5, MI=11.2, wei=0.5, bandwidth=0.5)
Scale.dependence.Beam_S.single=function(a,b,aaix,baix,mi,MI,wei,bandwidth)
{
