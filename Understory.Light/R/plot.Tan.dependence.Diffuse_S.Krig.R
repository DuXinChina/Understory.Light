...
#'
#' @return 加权进界邻体散射荫蔽度的Kring插值图
#' @export
#'
#' @examples
#' b=Understory.light::b
#' Understory.light::plot.Tan.dependence.Diffuse_S.Krig(minx=50, maxx=100, miny=50, maxy=100, b=b, seq=20, tan=2.8, MI=10.660, wei=0.5)
plot.Tan.dependence.Diffuse_S.Krig=function (minx, maxx, miny, maxy, b, seq, tan, MI,wei,tan2)
{
  library(sp)
  library(gstat)
  library(tcltk)
  ...
  data =  Tan.dependence.Diffuse_S.mult(basexy, b, tan, MI,wei,tan2)
  data1 = data
  ...
  p2 = p2 + labs(title = "Tan dependence Wei_S") +
